...
$tablea = mysql_query("SELECT `gameId` FROM `position` where `good`='1' and `total`!='1' and `total`!='2' and (gameId % 2) = 0 and `gameId`>'1785000000' and `gameId`<'1787000000' limit 100"); 
while($c = mysql_fetch_array($tablea)) {
echo $gid=$c['gameId'];
